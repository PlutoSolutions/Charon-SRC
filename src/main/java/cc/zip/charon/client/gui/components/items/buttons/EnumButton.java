...
extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Charon.fontManager.drawString(this.setting.getName() + " " + (Object)ChatFormatting.GRAY + this.setting.currentEnumName(), this.x + 2.3f, this.y - 1.7f - (float) Gui.getClickGui().getTextOffset(), this.getState() ? -1 : -5592406);
    }
