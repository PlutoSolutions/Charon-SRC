...
import cc.zip.charon.client.managers.FriendManager;
...
public class EntityUtilNigger
    ...
    public static boolean isntValid(Entity entity, double range) {
        return entity == null || isDead(entity) || entity.equals(mc.player) || entity instanceof EntityPlayer && Charon.INSTANCE.getFriendManager().isFriend(entity.getName()) || mc.player.getDistanceSq(entity) > MathUtil.square(range);
    }
    ...
    public static Color getColor(Entity entity, int red, int green, int blue, int alpha, boolean colorFriends) {
        ...
        if (entity instanceof EntityPlayer && colorFriends && Charon.INSTANCE.getFriendManager().isFriend((EntityPlayer) entity)) {
    ...
    public static Map<String, Integer> getTextRadarPlayers() {
        ...
        for (EntityPlayer player : mc.world.playerEntities) {
            ...
            output.put(healthSB.toString() + " " + (Charon.INSTANCE.getFriendManager().isFriend(player) ? ChatFormatting.AQUA : ChatFormatting.RED) + player.getName() + " " + distanceSB.toString() + " \u00c2\u00a7f0", (int) mc.player.getDistance(player));
